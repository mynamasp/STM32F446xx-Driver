...
Src/002LED_BUTTON.o: ../Src/002LED_BUTTON.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -I"/home/prasanna/STM32CubeIDE/workspace_1.3.0/STM32F446xx_Driver/drivers/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/002LED_BUTTON.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
